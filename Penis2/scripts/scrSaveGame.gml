...
{    
    ...
    global.savePlayerFacing = objPlayer.xScale;
    ...
    global.saveP2Item = global.p2Item;
    global.saveP2Crystal = global.p2Crystal;
    global.saveP2Flag = global.p2Flag;
...
ds_map_add(saveMap,"savePlayerFacing",global.savePlayerFacing);
...
ds_map_add(saveMap, "saveP2Item", int64(global.saveP2Item));
ds_map_add(saveMap, "saveP2Crystal", int64(global.saveP2Crystal));
ds_map_add(saveMap, "saveP2Flag", int64(global.saveP2Flag));
