...
global.roomCaptionDef = "***********"; //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rRealMenDontDie;    //sets which room to begin with
