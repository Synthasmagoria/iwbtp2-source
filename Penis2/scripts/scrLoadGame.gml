...
if (loadFile)
{
    ...
    if (saveMap != -1)  //check if the save map loaded correctly
    {
        ...
        global.saveP2Item = ds_map_find_value(saveMap, "saveP2Item");
        saveMap[?"saveP2Item"] = int64(saveMap[?"saveP2Item"]);
        global.saveP2Crystal = ds_map_find_value(saveMap, "saveP2Crystal");
        saveMap[?"saveP2Crystal"] = int64(saveMap[?"saveP2Crystal"]);
        global.saveP2Flag = ds_map_find_value(saveMap, "saveP2Flag");
        saveMap[?"saveP2Flag"] = int64(saveMap[?"saveP2Flag"]); // <- workaround to prevent triggering md5 problems
...
global.p2Item = global.saveP2Item;
global.p2Crystal = global.saveP2Crystal;
global.p2Flag = global.saveP2Flag;
