...
_forest_generator.finished_callback = scrP2ForestGeneratorEvent_GotoAutumnHallucinationForestSafe;
_forest_generator.forest_tileset = tP2Forest;
var _world = instance_find(oP2World, 0);
_forest_generator.leaf_particle = _world.forest_leaf_part_yellow;
